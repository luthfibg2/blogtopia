 <aside id="default-sidebar" class="top-0 left-0 z-40 w-64 h-full shrink-0 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
   ...
   <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-night-300 z-20 border-r border-gray-200 dark:border-gray-700">
