        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex flex-1/3 justify-start items-center">
                <a href="#" class="flex mr-4">
                  <img src="{{ asset('assets/images/blogtopia-logo.png') }}" class="mr-3 h-8" alt="FlowBite Logo" />
                  <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-steel-500">Blogtopia</span>
                </a>
            </div>
            <ul class="flex flex-1/3 justify-center items-center dark:text-day-300 gap-6">
                <li>
                    <a href="#">Semua</a>
                </li>
                <li>
